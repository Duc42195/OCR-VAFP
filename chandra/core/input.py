"""Input handling for loading images and PDFs."""
...
def load_image(
    ...
    """Load an image from file and resize if needed."""
...
def parse_range_str(range_str: str) -> List[int]:
    """Parse page range string like '1,2-5,7' into list of page numbers."""
